...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    const getDailySales = async () => {
      try {
        ...
        setDailySalesData(salesData);  // Set the fetched daily sales data
      } catch (err) {
  ...
  const leastSellingProduct: Product = filteredSalesData
    ...
    const bestSellingDate: DaySale = dailySalesData
    .sort((a, b) => b.total_sales - a.total_sales)
    .slice(0, 1)[0];
    ...
    <>
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
        <CardDataStats
          title="Total Sales"
          total={
            "$" + salesData.reduce((prev, current) => prev + current.total_sales, 0).toLocaleString()
          }
          rate="0.43%"
          levelUp
        >
        ...
        <CardDataStats title="Most Selling" total={mostSellingProduct.product} rate={"$"+mostSellingProduct.total_sales.toLocaleString()} levelUp>
          <svg
            className="fill-primary dark:fill-white"
            width="20"
            height="22"
        ...
        <CardDataStats title="Worst Selling Product" total={leastSellingProduct.product} rate={"$"+leastSellingProduct.total_sales.toString()} levelDown>
          <svg
            className="fill-primary dark:fill-white"
            width="22"
            height="22"
      ...
      <div className="mt-4 items-center grid  md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5">
        <SalesChart />
        {/* <ChartThree /> */}
        {/* <MapOne /> */}
